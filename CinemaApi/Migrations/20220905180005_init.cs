        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkersQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePerformings", x => new { x.MovieId, x.CinemaHallId });
                    table.ForeignKey(
                        name: "FK_MoviePerformings_CinemaHalls_CinemaHallId",
                        column: x => x.CinemaHallId,
                        principalTable: "CinemaHalls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePerformings_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    Rows = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeetReservings", x => new { x.Id, x.Rows, x.Seats });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePerformings_CinemaHallId",
