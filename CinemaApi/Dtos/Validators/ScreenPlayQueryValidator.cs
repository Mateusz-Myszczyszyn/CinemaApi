...
{
    public class ScreenPlayQueryValidator : AbstractValidator<ScreenPlayQuery>
    {
        private int[] allowedPageSizes = { 5 , 10 };
        private string[] allowedSortByColumnNames = { nameof(ScreenPlay.DigitalView), nameof(ScreenPlay.ShowTime) };
        public ScreenPlayQueryValidator()
        {
